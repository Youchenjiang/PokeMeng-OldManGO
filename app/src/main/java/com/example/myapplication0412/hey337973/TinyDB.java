...
package com.example.myapplication0412.hey337973;
...
//自定義SharedPreferences元件：https://github.com/kcochibili/TinyDB--Android-Shared-Preferences-Turbo/tree/master
//將ArrayList傳送到SharedPreferences：https://stackoverflow.com/questions/7057845/save-arraylist-to-sharedpreferences
//將ArrayList傳送到SharedPreferences：https://stackoverflow.com/questions/28107647/how-to-save-listobject-to-sharedpreferences
public class TinyDB {
    ...
    public TinyDB(Context appContext) {
        ...
        preferences = appContext.getSharedPreferences("com.example.myapplication0412.PREFERENCES", Context.MODE_PRIVATE);
        context = appContext;
    }
    ...
    public Bitmap getImage(String path) {
        ...
        try {
            ...
            Log.e("ERROR", "Error in getImage(): " + e.getMessage());
        }
    ...
    private boolean saveBitmap(String fullPath, Bitmap bitmap) {
        ...
        try {
            ...
            Log.e("ERROR", "Error writing bitmap to file"+e.getMessage());
        }
        ...
        try {
            ...
            if (out != null) {
                try {
                    ...
                    Log.e("ERROR", "Error closing stream"+e.getMessage());
                }
            }
        }
    ...
    public double getDouble(String key) {
        String number = getString(key, null);
    ...
    public <T> T getObject(String key, Class<T> classOfT) {
        ...
        if (json == null) {
            Log.e("TinyDB", "No data found for key: " + key);
            return null;
        }
        try {
            return new Gson().fromJson(json, classOfT);
        } catch (JsonSyntaxException e) {
            Log.e("TinyDB", "Error parsing JSON for key: " + key, e);
            return null;
        }
    }
    ...
    public boolean objectExists(String key) {
        String gottenString = getString(key, null);
